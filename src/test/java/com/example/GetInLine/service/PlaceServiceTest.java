...
class PlaceServiceTest {
    ...
    @Test
    void givenNothing_whenSearching_thenReturnsEntirePlaceList () {
        //Given
    ...
    @Test
    void givenDateRelatedException_whenSearchingPlaces_thenThrowsGeneralException () {
        //Given
    ...
    @DisplayName("장소 ID와 정보를 주면, 장소 정보를 변경하고 결과를 true로 보여준다.")
    @Test
    ...
    @DisplayName("장소 ID를 주지 않으면, 장소 정보 변경 중단하고 결과를 false로 보여준다.")
    @Test
    ...
    @DisplayName("장소 ID만 주고 변경할 정보를 주지 않으면, 장소 정보 변경 중단하고 결과를 false로 보여준다.")
    @Test
    ...
    @DisplayName("장소 ID를 주지 않으면, 삭제 중단하고 결과를 false로 보여준다.")
    @Test
