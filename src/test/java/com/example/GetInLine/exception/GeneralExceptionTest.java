...
class GeneralExceptionTest {
    ...
    @MethodSource
    @ParameterizedTest
    void givenException_whenInstantiating_thenContainsRelavantInformation(
    ...
    static Stream<Arguments> givenException_whenInstantiating_thenContainsRelavantInformation(){
